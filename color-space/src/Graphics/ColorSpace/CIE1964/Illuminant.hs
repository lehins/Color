...
{-# LANGUAGE DataKinds #-}
-- |
-- Module      : Graphics.ColorSpace.CIE1964.Illuminant
...
-- !
-- | @[x=0.44511, y=0.40594]@ - CIE 1964 10° Observer -
-- /CIE15: Technical Report: Colorimetry, 3rd edition/
instance Illuminant 'A   where whitePoint = WhitePoint 0.44511 0.40594


-- | @[x=0.34842, y=0.35161]@ - CIE 1964 10° Observer -
...
-- /CIE15: Technical Report: Colorimetry, 3rd edition/
instance Illuminant 'C   where whitePoint = WhitePoint 0.31039 0.31905

-- !
-- | @[x=0.34773, y=0.35952]@ - CIE 1964 10° Observer -
-- /CIE15: Technical Report: Colorimetry, 3rd edition/
instance Illuminant 'D50 where whitePoint = WhitePoint 0.34773 0.35952

-- !
-- | @[x=0.33412, y=0.34877]@ - CIE 1964 10° Observer -
-- /CIE15: Technical Report: Colorimetry, 3rd edition/
instance Illuminant 'D55 where whitePoint = WhitePoint 0.33412 0.34877

-- | @[x=0.32163, y=0.33774]@ - CIE 1964 10° Observer -
